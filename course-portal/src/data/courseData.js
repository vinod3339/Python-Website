...
export const materials = {
  ...
  week1LabSolution: {
    label: 'Week 1 Lab Solutions',
    filename: 'Week-1 Lab Solutions.ipynb',
    url: `${baseUrl}materials/Jupyter Notebooks/Week-1 Lab Solutions.ipynb`,
  },
  week2LabTask: {
  ...
  week2LabSolution: {
    label: 'Week 2 Lab Solutions',
    filename: 'Week-2 Lab Solutions.ipynb',
    url: `${baseUrl}materials/Jupyter Notebooks/Week-2 Lab Solutions.ipynb`,
  },
  ...
  week3LabSolution: {
    label: 'Week 3 Lab Solutions',
    filename: 'Week-3 Lab Solutions.ipynb',
    url: `${baseUrl}materials/Jupyter Notebooks/Week-3 Lab Solutions.ipynb`,
  },
  week4LabTask: {
  ...
  week4LabSolution: {
    label: 'Week 4 Lab Solutions',
    filename: 'Week-4 Lab Solutions.ipynb',
    url: `${baseUrl}materials/Jupyter Notebooks/Week-4 Lab Solutions.ipynb`,
  },
  week5LabTask: {
  ...
  week5LabSolution: {
    label: 'Week 5 Lab Solutions',
    filename: 'Week-5 Lab Solutions.ipynb',
    url: `${baseUrl}materials/Jupyter Notebooks/Week-5 Lab Solutions.ipynb`,
  },
  week6LabTask: {
...
export const assignments = [
  ...
  },
  {
    ...
    resources: [
      ...
      {
        label: 'Week 1 Lab Solutions (Notebook)',
        type: 'ipynb',
        url: materials.week1LabSolution.url,
        download: materials.week1LabSolution.filename,
        icon: 'journal-code',
      },
    ],
  ...
  },
  {
    ...
    resources: [
      ...
      {
        label: 'Week 2 Lab Solutions (Notebook)',
        type: 'ipynb',
        url: materials.week2LabSolution.url,
        download: materials.week2LabSolution.filename,
        icon: 'journal-code',
      },
      {
  ...
  },
  {
    ...
    resources: [
      ...
      {
        label: 'Week 3 Lab Solutions (Notebook)',
        type: 'ipynb',
        url: materials.week3LabSolution.url,
        download: materials.week3LabSolution.filename,
        icon: 'journal-code',
      },
    ],
  ...
  },
  {
    ...
    resources: [
      ...
      {
        label: 'Week 4 Lab Solutions (Notebook)',
        type: 'ipynb',
        url: materials.week4LabSolution.url,
        download: materials.week4LabSolution.filename,
        icon: 'journal-code',
      },
    ],
  ...
  },
  {
    ...
    resources: [
      ...
      {
        label: 'Week 5 Lab Solutions (Notebook)',
        type: 'ipynb',
        url: materials.week5LabSolution.url,
        download: materials.week5LabSolution.filename,
        icon: 'journal-code',
      },
    ],
  ...
  },
  {
    ...
    resources: [
      ...
      {
        label: 'Week 6 Lab Solutions (Notebook)',
        type: 'ipynb',
        url: materials.week6LabSolution.url,
        download: materials.week6LabSolution.filename,
        icon: 'journal-code',
      },
    ],
